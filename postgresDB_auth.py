...
def insert_user(username, role, permissions, password):
    ...
    INSERT INTO usersDB (username, role, permissions, hashed_password, salt) VALUES ({}, {}, {}, {}, {});
    """).format(sql.Literal(username), sql.Literal(role), sql.Literal(permissions), sql.Literal(psycopg2.Binary(hashed_password)),  sql.Literal(psycopg2.Binary(salt)))
